(function(){
    ...
    const backbtn = document.querySelector("#thirdbtn");
    ...
    //if users click back it takes them to the previous form
    backbtn.addEventListener("click", function(event){
        ...
        //in case user makes an error and goes back to previous page.
        errormessage.style.display="none";
     });
    ...
    secondbtn.addEventListener("click", function(event){
        ...
        if(planet=="Jupiter"){
            ...
            document.querySelector("#planetimage").className="jupitertype";
        } else if(planet=="Neptune"){
            document.querySelector("#planetimage").className="neptunetype";
        }
    ...
    thirdbtn.addEventListener("click", function(){
        ...
        document.querySelector("input[name=planet]").checked = "Jupiter";
